  ...
  tr: {
    ...
    journey: {
      ...
      stops: [
        ...
        { year: "2024", period: "Oca 2024 – Haz 2026", title: "Kulüpler", text: "IT&MIS Kulübü'nün başkanlığını iki yıl yürüttüm; etkinlikleri planlayıp ekipleri koordine ettim. 2026'da Işık Run Club'ın kurucuları arasında yer aldım.", tag: "Liderlik", details: ["IT&MIS Kulübü — Başkan: söyleşi, zirve, hackathon ve kariyer fuarı", "IT&MIS Kulübü — şirket gezileri ve mülakat simülasyonları", "Işık Run Club — kurucu üye: koşu, trekking ve sosyal etkinlikler"] },
