...
export const home: Record<Lang, HomeDict> = {
  tr: {
    nav: { about: "Hakkımda", journey: "Yolculuk", projects: "Projeler", research: "Araştırma", skills: "Yetkinlikler", contact: "İletişim", cv: "CV", menu: "Menüyü aç", menuClose: "Menüyü kapat", skipIntro: "Geç", temaAcik: "Açık temaya geç", temaKoyu: "Koyu temaya geç" },
    hero: {
      kicker: "Yönetim Bilişim Sistemleri · Işık Üniversitesi",
      line1: "“Bir insan gelişir,",
      line2: "dünya değişir.”",
      sub: "Bu vizyonla çıktığım yolculukta akademik ve kişisel gelişimimi sizlerle paylaşıyorum. Öğrendiğim her şeyin önce beni, sonra birlikte çalıştığım insanları ve ortaya çıkan işi değiştirdiğine inanıyorum.",
      ctaProjects: "Projelere bak",
      ctaCv: "CV'yi aç",
    },
    stats: [
      { value: 3.43, decimals: 2, label: "Genel not ortalaması / 4" },
      { value: 3, label: "Yıl kulüp başkanlığı" },
    ...
    projects: {
      ...
      cards: [
        ...
        { title: "Veteriner Yönetim Sistemi", status: "Ekip Projesi · Yürütücü", statusKind: "team", period: "2025", text: "Bir veteriner kliniğinin hasta, randevu ve tedavi kayıtlarını tek sistemde yönetmesini sağlayan uygulamayı, beş kişilik ekipte proje yürütücüsü olarak yürüttüm.", tech: ["Spring Boot", "React", "MySQL", "JWT"], url: "https://github.com/tolguner/Veterinary-Management-System" },
        ...
        { title: "tolguner.me", status: "Canlı", statusKind: "live", period: "2026", text: "Bu site. Next.js, Three.js ve GSAP ile scroll'a bağlı bir deneyim kurdum; içeriği Postgres'e taşıyıp giriş gerektiren bir panelden yönetilir hâle getirdim — artık metin değiştirmek için kod düzenlemiyorum.", tech: ["Next.js", "TypeScript", "Supabase", "Three.js", "GSAP"], url: "https://github.com/tolguner/tolguner.github.io" },
      ],
  ...
  en: {
    ...
    hero: {
      ...
      sub: "On the journey I set out on with this vision, I share my academic and personal growth here. I believe everything I learn changes me first, then the people I work with and the work we produce.",
      ctaProjects: "See projects",
      ctaCv: "Open CV",
    },
    stats: [
      { value: 3.43, decimals: 2, label: "GPA / 4" },
      { value: 3, label: "Years as club president" },
    ...
    projects: {
      ...
      cards: [
        ...
        { title: "Veterinary Management System", status: "Team · Lead", statusKind: "team", period: "2025", text: "I led the application that lets a veterinary clinic manage patient, appointment and treatment records in one system, as project lead in a five-person team.", tech: ["Spring Boot", "React", "MySQL", "JWT"], url: "https://github.com/tolguner/Veterinary-Management-System" },
        ...
        { title: "tolguner.me", status: "Live", statusKind: "live", period: "2026", text: "This site. I built a scroll-driven experience with Next.js, Three.js and GSAP, then moved the content into Postgres and put it behind a login-protected admin panel — changing text no longer means editing code.", tech: ["Next.js", "TypeScript", "Supabase", "Three.js", "GSAP"], url: "https://github.com/tolguner/tolguner.github.io" },
      ],
    ...
    skills: {
      ...
      groups: [
        ...
        { label: "Frontend", items: ["React", "Next.js", "Tailwind CSS"] },
        { label: "Data & Analysis", items: ["pandas", "Jupyter"] },
