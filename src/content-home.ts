...
export const home: Record<Lang, HomeDict> = {
  tr: {
    ...
    hero: {
      ...
      line2: "dünya değişir.”",
      sub: "İki şeyi aynı anda öğrenmeye çalışıyorum: sistem kurmayı ve insanları bir araya getirmeyi. İlki Spring Boot ve React ile yazdığım uygulamalarda, TÜBİTAK 2209-A destekli araştırmamda; ikincisi iki yıl yönettiğim kulüpte ve düzenlediğim organizasyonlarda. Aşağısı ikisinin kesiştiği yer.",
  ...
  en: {
    ...
    hero: {
      ...
      sub: "I'm learning two things at once: how to build systems, and how to bring people together. The first shows in the applications I write with Spring Boot and React and in the TÜBİTAK 2209-A funded research I lead; the second in the club I ran for two years and the events I organized. Below is where the two meet.",
