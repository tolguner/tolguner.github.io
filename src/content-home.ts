...
export const home: Record<Lang, HomeDict> = {
  tr: {
    ...
    hero: {
      ...
      line2: "dünya değişir.”",
      sub: "Bu vizyonla çıktığım yolculukta akademik ve kişisel gelişimimi sizlerle paylaşıyorum. Yazdığım kod kadar bir araya getirdiğim ekipler de bu yolun parçası: Spring Boot ve React ile kurduğum sistemler, TÜBİTAK 2209-A destekli araştırmam ve iki yıl yönettiğim kulüp.",
  ...
  en: {
    ...
    hero: {
      ...
      sub: "This is the journey I set out on with that vision, and I share my academic and personal growth here. The teams I brought together are as much a part of it as the code I wrote: systems built with Spring Boot and React, a TÜBİTAK 2209-A funded research project, and two years leading a student club.",
