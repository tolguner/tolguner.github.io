...
export const home: Record<Lang, HomeDict> = {
  tr: {
    ...
    hero: {
      ...
      line2: "dünya değişir.”",
      sub: "Bu vizyonla çıktığım yolculuğu burada paylaşıyorum: Spring Boot ve React ile geliştirdiğim uygulamaları, TÜBİTAK 2209-A destekli araştırmamı ve bir kulübü iki yıl yönetirken öğrendiklerimi. Değişim büyük hedeflerle değil, insanın kendini geliştirdiği sürekli küçük adımlarla başlıyor; buradakilerin her biri o adımlardan biri.",
  ...
  en: {
    ...
    hero: {
      ...
      sub: "This is the vision I set out with, and the journey I share here: the applications I build with Spring Boot and React, the TÜBİTAK 2209-A funded research I lead, and what two years of running a student club taught me. Change doesn't begin with grand goals but with the small, steady steps of someone who keeps learning; everything here is one of those steps.",
